    ...
    if len(in_list) == 0:
        ...
        for img in in_list:
            with Image.open(os.getcwd() + "/input/" + img) as im:
                ...
                preprocessed_image = Image.open(os.getcwd() + '/preprocessed/' + img)
                ...
                for i, contour in enumerate(contours):
                    ...
                    cropped_image_path = './cropped/' + img[0] + '_' + str(i) + '.jpeg'
                    cv2.imwrite(cropped_image_path, roi)

                    # Open and display with PIL
                    cropped_pil_image = Image.open(cropped_image_path)
